# ===========================================================================
#     https://www.gnu.org/software/autoconf-archive/ax_boost_random.html
# ===========================================================================
#
# SYNOPSIS
#
	...
	if test "x$want_boost" = "xyes"; then
		...
		AC_CACHE_CHECK(whether the Boost::Random library is available,
            ax_cv_boost_random, [
				...
				AC_COMPILE_IFELSE([
					AC_LANG_PROGRAM([[@%:@include <boost/random.hpp>]],
                        [[boost::random::mt19937 rng; boost::random::uniform_int_distribution<> six(1,6); int x = six(rng);]])
                    ],
                    ax_cv_boost_random=yes,
                    ax_cv_boost_random=no
				)
		...
		if test "x$ax_cv_boost_random" = "xyes"; then
			...
			if test "x$ax_lib" = "x"; then
				AC_MSG_ERROR(Could not find a version of the Boost::Random library!)
			fi
